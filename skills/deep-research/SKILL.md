...
Both together give the best coverage. Configure in `~/.claude.json` or `the host MCP configuration`.
...
For broad topics, use host-provided subagent support to parallelize when available:
