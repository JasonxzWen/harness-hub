...
- `insight` during finish closeout when the work should be audited for tool-calling quality, repeated manual corrections, doc/code conflicts, AI infrastructure lessons, or possible skill/workflow extraction.
