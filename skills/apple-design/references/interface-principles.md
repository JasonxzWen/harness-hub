# Apple Interface Principles

Source: preserved from `emilkowalski/skills` at `7bb7061b5cf7de15ea1aeaf00fbd9e6592a20fce` under MIT.

Harness Hub note: treat concrete browser, media-query, animation-library, and performance claims as version-sensitive. Verify current official documentation and profile the target product before turning them into implementation requirements.

## Contents

- [The Core Idea](#the-core-idea)
- [Response](#1-response--kill-latency)
- [Direct manipulation](#2-direct-manipulation--11-tracking)
- [Interruptibility](#3-interruptibility--the-single-most-important-principle)
- [Behavior over animation](#4-behavior-over-animation--use-springs)
- [Velocity handoff](#5-velocity-handoff--the-seam-between-drag-and-animation)
- [Momentum projection](#6-momentum-projection--animate-to-where-the-gesture-is-going)
- [Spatial consistency](#7-spatial-consistency--symmetric-paths-anchored-origins)
- [Gesture hints and boundaries](#8-hint-in-the-direction-of-the-gesture)
- [Gesture details](#10-gesture-design-details-the-feel-checklist)
- [Frame-level smoothness](#11-frame-level-smoothness)
- [Materials and depth](#12-materials--depth--translucency-conveys-hierarchy)
- [Multimodal feedback](#13-multimodal-feedback--motion--sound--haptics)
- [Accessibility](#14-reduced-motion--accessibility)
- [Typography](#15-typography--optical-sizing-tracking-leading)
- [Design foundations](#16-design-foundations--the-eight-principles)
- [Process](#17-process)
