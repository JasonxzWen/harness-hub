---
name: internal-comms
description: Load when the user asks to draft or revise internal communications such as status reports, leadership updates, 3P updates, newsletters, FAQs, incident reports, or project updates; do not load for public marketing copy or technical docs.
