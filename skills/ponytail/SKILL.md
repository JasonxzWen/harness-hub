...
Off only: "stop ponytail" / "normal mode". Default: **full**. Switch:
...
Ponytail governs what you build, not full requested reports or durable
communication artifacts. "stop ponytail" / "normal mode": revert. Level
