...
metadata:
  ...
  adaptation: "Platform-neutral Skill Hub version; host-specific eval scripts and UI metadata are excluded."
---
...
Use `docs/skill-quality-guide.md` when working inside Skill Hub.
