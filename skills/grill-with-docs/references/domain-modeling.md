# Domain modeling with project OKF

- Stable project concepts are UTF-8 Markdown under `knowledge/` with non-empty frontmatter `type`.
- `knowledge/index.md` links every concept and declares OKF `0.1`.
- `knowledge/log.md` records dated changes.
