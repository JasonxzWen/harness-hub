...
- [Entrances and exits](#entrances--exits--how-elements-appear-and-disappear)
- [Sequencing and timing](#sequencing--timing--coordinating-multiple-elements-or-moments)
- [Movement and transforms](#movement--transforms--changing-an-elements-position-size-or-angle)
- [Transitions between states](#transitions-between-states--connecting-one-state-view-or-element-to-another)
- [Scroll](#scroll--motion-tied-to-scrolling-or-navigating-between-views)
- [Feedback and interaction](#feedback--interaction--responding-to-the-users-actions)
- [Easing](#easing--how-speed-changes-over-an-animation)
- [Spring animations](#spring-animations--physics-based-motion-as-an-alternative-to-fixed-duration-easing)
- [Looping and ambient motion](#looping--ambient-motion--animations-that-run-on-their-own)
- [Polish and effects](#polish--effects--the-small-touches-that-separate-good-from-great)
- [Performance](#performance--what-keeps-motion-smooth-instead-of-stuttering)
- [Principles](#principles-to-know--concepts-that-guide-when-and-how-to-animate)
