...
| `emilkowalski/skills` | `7bb7061b5cf7de15ea1aeaf00fbd9e6592a20fce` | MIT | Evaluated as an interaction-craft reference. No source body is distributed; the first frontend slice keeps only independent, evidence-based review guidance. |
| `Trystan-SA/claude-design-system-prompt` | `3c3ddb07d7aa3fef051d83608596470c95cfd8fe` | Repository MIT; the reverse-engineered prompt's original provenance is not independently established | An active provenance safety boundary for frontend capability research. No source body is distributed, and no prompt or Host text is copied. |
| `yetone/kill-ai-slop` and `killaislop.com` | `e2456514416e40f133432baf364a2353900267a7` | No repository license found at the evaluated revision | Research reference only for frontend AI-slop taxonomy and critique patterns. No source body is distributed; the upstream Skill, scanner, website code, and prose are not copied or adapted, while `product-ui-review` independently treats style patterns as contextual clues only. |
