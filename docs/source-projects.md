...
| --- | --- | --- | --- |
| `mattpocock/skills` | `d574778f94cf620fcc8ce741584093bc650a61d3` | MIT | Adapted atomic Skills including `grill-me`, `diagnose`, `prototype`, `tdd-workflow`, and `handoff`; Claude Code or Codex invokes them directly. |
