...
| `.harness-hub/state/session-handoff.md` | Restart path, changed files, validation, stale-read result, final review, insight recommendations, residual risk, next action. | A duplicate of the whole chat transcript. |
