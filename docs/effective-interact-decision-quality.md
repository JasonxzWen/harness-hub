...
- advisory aesthetic preflight warnings, selectively derived from `Leonxlnx/taste-skill`, for AI-purple/glow, default-card grids, repeated section shapes, billboard heroes, decorative split headers, spacing/type/motion discipline, and reduced-motion coverage in generated HTML reports.
...
- validator checks for intent, claim/evidence links, chart accessibility, runtime auditability, unsafe sinks, focus visibility, reduced motion, chart containment, decision-brief structure, rich-content opportunity signals, and aesthetic preflight signals.
