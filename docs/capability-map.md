...
| `harness-hub loop required <target>` | No | Derive required closeout loops from dirty worktree paths and return a non-zero gate when review evidence is required before handoff. |
