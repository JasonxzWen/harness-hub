...
原生主 Agent直接选择有独立领域价值的 Skills。开发原子能力包括 `grill-me`、`grill-with-docs`、`product-capability`、`to-tickets`、`tdd`、`codebase-design`、`code-review` 和 `verification`；其他能力包括 Ponytail、effective-interact、quick-learn、source-post、Agent Reach、Decision UI、安全审查和 Agent interaction audit。
