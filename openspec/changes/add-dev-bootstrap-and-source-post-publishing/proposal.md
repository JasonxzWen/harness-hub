...
- Add a specification for `source-post-publishing-loop`.
- Define `effective-interact` as the initial blog generation layer for published source posts.
