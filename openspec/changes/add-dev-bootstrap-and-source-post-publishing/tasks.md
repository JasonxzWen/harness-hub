...
## 3. Source-Post Publishing Loop Implementation
...
- [x] 3.3 Add an `effective-interact` fixture for source post generation.
...
- [x] 3.8 Add docs for the source-to-post workflow and manual/automation approval boundary.

## 4. Integration and Validation

- [x] 4.1 Ensure bootstrap implementation does not broaden low-level `install` semantics unless explicitly accepted.
- [x] 4.2 Ensure source-post publishing does not reuse ignored local artifact directories as the public site source.
