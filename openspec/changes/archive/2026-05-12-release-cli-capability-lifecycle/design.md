...
- Solving every agent host at once. Codex and `skills` remain the first-class path; Claude Code and OpenCode support is metadata-driven and tested where practical.
